            ...
            <tbody>
                @foreach ($propertyList as $item)
                    <tr>
                        ...
                        <td class="table-cell"><a href="property/{{ $item->id }}" class="link">{{ $item->name }}</a>
                        </td>
                        ...
                        <td class="table-cell text-center"><input type="checkbox" value="{{ $item->has_garden }}" /></td>
                        <td class="table-cell text-center"><input type="checkbox" value="{{ $item->has_garage }}" /></td>
                        <td class="table-cell">
